...
#CODIGO DISPONIBILIZADO PELO PROFESSOR, SOMENTE CORRIGI A TEXTURA PARA EXIBICAO CORRETA DAS FACES
...
# Front Face
    ...
    # Back Face
    glTexCoord2f(.66, .5); glVertex3f(-1.0, -1.0, -1.0)
    glTexCoord2f(.66, 1.0); glVertex3f(-1.0,  1.0, -1.0)
    ...
    glTexCoord2f(.33, 1.0); glVertex3f(1.0,  1.0,  1.0)
    glTexCoord2f(.33, .5); glVertex3f(1.0,  1.0, -1.0)

    # Bottom Face
    glTexCoord2f(.66, 0); glVertex3f(-1.0, -1.0, -1.0)
    ...
    glTexCoord2f(.66, .5); glVertex3f(1.0,  1.0, -1.0)
    glTexCoord2f(.33, .5); glVertex3f(1.0,  1.0,  1.0)
    glTexCoord2f(.33, 1); glVertex3f(1.0, -1.0,  1.0)

    # Left Face
    glTexCoord2f(.33, .5); glVertex3f(-1.0, -1.0, -1.0)
    glTexCoord2f(.33, 0); glVertex3f(-1.0, -1.0,  1.0)
    glTexCoord2f(.66, 0); glVertex3f(-1.0,  1.0,  1.0)
    glTexCoord2f(.66, .5); glVertex3f(-1.0,  1.0, -1.0)
